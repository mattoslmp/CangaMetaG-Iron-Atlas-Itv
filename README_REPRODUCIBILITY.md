...
## Static Plotly exports

See `docs/code/PLOTLY_STATIC_EXPORTS.md` and run:
...
The application uses Kaleido first and a local Chromium/Playwright fallback second. `PLOTLY_CHROME_PATH` can override browser discovery.
